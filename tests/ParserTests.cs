...
namespace tests
{
    ...
    public class ParserTests
    {
        ...
        public void TestCommandParsing()
        {
            ...
            Assert.That(chats[0].Count, Is.EqualTo(1));
            Assert.That(chats[0].GetType(), Is.EqualTo(typeof(Chat)));
            Assert.That(chats[0].commands[0].GetText(), Is.EqualTo("Twirl"));
            ...
            Assert.That(chats[0].Count, Is.EqualTo(1));
            Assert.That(chats[0].GetType(), Is.EqualTo(typeof(Chat)));
            Assert.That(chats[0].commands[0].GetText(), Is.EqualTo("Thank you"));
        ...
        public void TestOpsParsing()
        {
            ...
            Find finder = (Dialogic.Find)chat.commands[0];
            Assert.That(finder.GetType(), Is.EqualTo(typeof(Find)));
            Assert.That(finder.Query(), Is.Not.Null);
        }
