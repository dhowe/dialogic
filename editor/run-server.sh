...
if [ ! -f "/Users/dhowe/git/dialogic/editor/bin/Debug/editor.exe" ]; then
...
"/Library/Frameworks/Mono.framework/Versions/5.8.1/bin/mono32" --debug "/Users/dhowe/git/dialogic/editor/bin/Debug/editor.exe"
