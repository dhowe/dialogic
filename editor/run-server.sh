...
if [ ! -f "/Users/dhowe/git/dialogic/editor/bin/Debug/netcoreapp2.0/editor.exe" ]; then
    echo >&2 "exe not found!"
    exit
fi

cd "/Users/dhowe/git/dialogic/editor/bin/Debug";
...
"/Library/Frameworks/Mono.framework/Versions/5.8.1/bin/mono32" --debug "/Users/dhowe/git/dialogic/editor/bin/Debug/netcoreapp2.0/editor.exe"
